...
class PacketFlowAnalyzer(
    ...
    private val cheatPatterns = mapOf(
        "liquidbounce" to CheatPattern(
            name = "LiquidBounce",
            patterns = listOf(
                PacketPattern("Move", "Position", "Move", "Position", 0.9),
                PacketPattern("Flying", "Position", "Move", "Flying", 0.85),
                PacketPattern("Move", "Move", "Move", "Position", 0.8)
            ),
        ...
        "wurst" to CheatPattern(
            name = "Wurst",
            patterns = listOf(
                PacketPattern("Move", "Position", "Move", "Position", 0.8),
                PacketPattern("Attack", "Move", "Attack", "Move", 0.75)
            ),
            timingAnomalies = listOf(
        ...
        "impact" to CheatPattern(
            name = "Impact",
            patterns = listOf(
                PacketPattern("Move", "Move", "Position", "Move", 0.85),
                PacketPattern("Flying", "Move", "Flying", "Move", 0.8)
            ),
            timingAnomalies = listOf(
